...
class ServiceObjectPeopleTest {
    ...
    @Test
    void testGetPeopleWithoutQueryParams() {
        final var response = new PeopleApiClient(requestSpecification, responseSpecification)
            .getPeople()
            .then()
    ...
    @Test
    void testGetPeopleWithQueryParams() {
        final var response = new PeopleApiClient(requestSpecification, responseSpecification)
            .getPeople(Map.of("limit", 1))
            .then()
            .statusCode(HttpStatus.SC_OK)
